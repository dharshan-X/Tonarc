...
Tonarc is licensed under the GNU General Public License v3.0 (GPL-3.0). The app also includes third-party libraries and font assets. This file records source and license evidence useful for app-store and F-Droid review.
...
The Jellyfin FFmpeg decoder bundled in the APK is GPL-3.0, consistent with the Tonarc source license (GPL-3.0).
