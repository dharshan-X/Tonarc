...
import com.quietrays.tonarc.data.diagnostics.AdvancedPerformanceDiagnosticsController
...
import com.quietrays.tonarc.presentation.viewmodel.LibraryStateHolder
import com.quietrays.tonarc.presentation.viewmodel.ThemeStateHolder
...
import com.quietrays.tonarc.utils.MediaMetadataRetrieverPool
...
@HiltAndroidApp
class TonarcApplication : Application(), ImageLoaderFactory, Configuration.Provider {
    ...
    @Inject
    lateinit var navidromeCoilFetcherFactory: dagger.Lazy<com.quietrays.tonarc.data.image.NavidromeCoilFetcher.Factory>

    @Inject
    lateinit var jellyfinCoilFetcherFactory: dagger.Lazy<com.quietrays.tonarc.data.image.JellyfinCoilFetcher.Factory>

    @Inject
    lateinit var localArtworkCoilFetcherFactory: dagger.Lazy<com.quietrays.tonarc.data.image.LocalArtworkCoilFetcher.Factory>
    ...
    @Inject
    lateinit var syncManager: dagger.Lazy<com.quietrays.tonarc.data.worker.SyncManager>
    ...
    override fun onCreate() {
        ...
        startupScope.launch {
            AlbumArtUtils.migrateLegacyCacheLocation(this@TonarcApplication)
