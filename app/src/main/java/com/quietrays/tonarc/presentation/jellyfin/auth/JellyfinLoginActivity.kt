package com.quietrays.tonarc.presentation.jellyfin.auth
...
import com.quietrays.tonarc.presentation.components.CloudLibraryPickerItem
import com.quietrays.tonarc.presentation.components.CloudLibraryPickerSheet
...
class JellyfinLoginActivity : ComponentActivity() {
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.quietrays.tonarc.utils.AppLocaleManager.wrapContext(newBase))
    }
        ...
        Column(
            ...
            Button(
                ...
                if (isLoading) {
                    ...
                    Text(stringResource(R.string.auth_connecting), fontFamily = RoundedSans)
                } else {
                    Text(stringResource(R.string.auth_connect), fontFamily = RoundedSans, fontWeight = FontWeight.SemiBold)
                }
            }
...
@Composable
private fun JellyfinLoginField(
    value: String,
