...
import com.quietrays.tonarc.data.media.ImageCacheManager
import com.quietrays.tonarc.data.media.MetadataEditError
...
import com.quietrays.tonarc.utils.FileDeletionUtils
    ...
    suspend fun saveMetadata(
        ...
        val finalCoverArtUpdate = if (coverArtUpdate == null) {
            val existingMetadata = try {
                 com.quietrays.tonarc.data.media.AudioMetadataReader.read(java.io.File(song.path))
            } catch (e: Exception) {
                null
            }
