...
import com.quietrays.tonarc.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.quietrays.tonarc.presentation.viewmodel.StablePlayerState>
    ) {
