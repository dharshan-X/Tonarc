...
import com.quietrays.tonarc.data.database.AlbumArtThemeEntity
import com.quietrays.tonarc.data.database.StoredColorSchemeValues
import com.quietrays.tonarc.data.database.toComposeColor
import com.quietrays.tonarc.utils.LocalArtworkUri
import com.quietrays.tonarc.utils.traceAsyncSection
import com.quietrays.tonarc.ui.theme.clearExtractedColorCache
import com.quietrays.tonarc.ui.theme.extractSeedColor
import com.quietrays.tonarc.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.quietrays.tonarc.ui.theme.ColorExtractionConfig(
