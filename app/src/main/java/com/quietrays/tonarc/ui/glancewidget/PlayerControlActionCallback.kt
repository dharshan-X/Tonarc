...
object PlayerActions {
    ...
    const val PLAY_PAUSE = "com.quietrays.tonarc.ACTION_WIDGET_PLAY_PAUSE"
    const val NEXT = "com.quietrays.tonarc.ACTION_WIDGET_NEXT"
    const val PREVIOUS = "com.quietrays.tonarc.ACTION_WIDGET_PREVIOUS"
    const val FAVORITE = "com.quietrays.tonarc.ACTION_WIDGET_FAVORITE"
    const val PLAY_FROM_QUEUE = "com.quietrays.tonarc.ACTION_WIDGET_PLAY_FROM_QUEUE"
    const val SHUFFLE = "com.quietrays.tonarc.ACTION_WIDGET_SHUFFLE"
    const val REPEAT = "com.quietrays.tonarc.ACTION_WIDGET_REPEAT"
}
