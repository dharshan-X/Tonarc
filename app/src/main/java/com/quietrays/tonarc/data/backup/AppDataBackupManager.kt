...
import com.quietrays.tonarc.data.database.FavoritesEntity
...
import com.quietrays.tonarc.data.database.TransitionRuleEntity
import com.quietrays.tonarc.data.preferences.PreferenceBackupEntry
    ...
    suspend fun exportToUri(
        ...
        runCatching {
            ...
            reportProgress(
                ...
                detail = "Your Tonarc backup was created successfully."
            )
        }
    }
