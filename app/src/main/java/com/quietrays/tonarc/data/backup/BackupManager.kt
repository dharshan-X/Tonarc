package com.quietrays.tonarc.data.backup

import android.content.Context
import android.net.Uri
import android.os.Build
import com.quietrays.tonarc.data.backup.format.BackupCrypto
import com.quietrays.tonarc.data.backup.format.BackupEncryptedException
import com.quietrays.tonarc.data.backup.format.BackupFormatDetector
import com.quietrays.tonarc.data.backup.format.BackupReader
import com.quietrays.tonarc.data.backup.format.BackupWrongPassphraseException
import com.quietrays.tonarc.data.backup.format.BackupWriter
import com.quietrays.tonarc.data.backup.history.BackupHistoryRepository
import com.quietrays.tonarc.data.backup.model.BackupHistoryEntry
import com.quietrays.tonarc.data.backup.model.BackupManifest
...
import com.quietrays.tonarc.data.backup.model.BackupValidationResult
import com.quietrays.tonarc.data.backup.model.DeviceInfo
import com.quietrays.tonarc.data.backup.model.RestorePlan
import com.quietrays.tonarc.data.backup.model.RestoreResult
import com.quietrays.tonarc.data.backup.module.BackupModuleHandler
import com.quietrays.tonarc.data.backup.restore.RestoreExecutor
import com.quietrays.tonarc.data.backup.restore.RestorePlanner
import com.quietrays.tonarc.data.backup.validation.BackupFileValidator
import com.quietrays.tonarc.data.backup.validation.ValidationPipeline
...
class BackupManager @Inject constructor(
    ...
    suspend fun export(
        ...
        runCatching {
            ...
            reportProgress(onProgress, BackupOperationType.EXPORT, ++step, totalSteps,
                "Backup complete", "Your Tonarc backup was created successfully.")
        }
    }
