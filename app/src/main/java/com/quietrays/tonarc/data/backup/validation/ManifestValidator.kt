...
class ManifestValidator @Inject constructor() {
     ...
     *
     * Strict by design: both [com.quietrays.tonarc.data.backup.format.BackupWriter]
     * and [com.quietrays.tonarc.data.backup.format.LegacyPayloadAdapter] always emit
