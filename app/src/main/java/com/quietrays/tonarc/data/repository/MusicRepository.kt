...
interface MusicRepository {
     ...
     */
    fun getPaginatedSongs(sortOption: com.quietrays.tonarc.data.model.SortOption, storageFilter: com.quietrays.tonarc.data.model.StorageFilter): Flow<PagingData<Song>>

    /**
     * Returns paginated albums for efficient display in library tabs.
     */
    fun getPaginatedAlbums(
        sortOption: com.quietrays.tonarc.data.model.SortOption,
        storageFilter: com.quietrays.tonarc.data.model.StorageFilter = com.quietrays.tonarc.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.quietrays.tonarc.data.model.SortOption = com.quietrays.tonarc.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.quietrays.tonarc.data.model.StorageFilter = com.quietrays.tonarc.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.quietrays.tonarc.data.model.SortOption = com.quietrays.tonarc.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.quietrays.tonarc.data.model.StorageFilter = com.quietrays.tonarc.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.quietrays.tonarc.data.model.SortOption = com.quietrays.tonarc.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.quietrays.tonarc.data.model.StorageFilter = com.quietrays.tonarc.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.quietrays.tonarc.data.model.SortOption = com.quietrays.tonarc.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.quietrays.tonarc.data.model.StorageFilter = com.quietrays.tonarc.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     */
    fun getGenres(): Flow<List<com.quietrays.tonarc.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.quietrays.tonarc.data.model.StorageFilter = com.quietrays.tonarc.data.model.StorageFilter.ALL
    ): Flow<List<com.quietrays.tonarc.data.model.MusicFolder>>

    suspend fun deleteById(id: Long)

    suspend fun getSongIdsSorted(
        sortOption: com.quietrays.tonarc.data.model.SortOption,
        storageFilter: com.quietrays.tonarc.data.model.StorageFilter
    ): List<Long>
