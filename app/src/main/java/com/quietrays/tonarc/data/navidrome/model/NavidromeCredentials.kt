package com.quietrays.tonarc.data.navidrome.model
 ...
 * [com.quietrays.tonarc.data.navidrome.model.NavidromeAuthMethod].
 *
 ...
 * @property clientId The client identifier sent to the server (default: "Tonarc")
 */
data class NavidromeCredentials(
    val serverUrl: String,
    val username: String,
    val password: String,
    val clientId: String = "Tonarc"
) {
    companion object {
        /**
